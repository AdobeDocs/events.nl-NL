...
* [Vergelijking tussen groepen en teams](https://experienceleague.adobe.com/nl/docs/workfront/using/teams-groups/work-with-groups-teams/understanding-differences-and-similarities-between-groups-and-teams)
* [Groepsoverzicht](https://experienceleague.adobe.com/nl/docs/workfront/using/administration-and-setup/manage-groups/groups/groups)
* [Teams - Overzicht](https://experienceleague.adobe.com/nl/docs/workfront/using/teams-groups/create-manage-teams/teams-overview)

Hier volgen enkele bonusartikelen over het delen van objecten, toegangsniveaus en machtigingen:

* [Overerfde machtigingen voor objecten weergeven](https://experienceleague.adobe.com/nl/docs/workfront/using/basics/grant-request-object-permissions/view-inherited-permissions-on-objects)
