---
title: In Mayo Clinic - Hoe helpt Workfront Fusion de Mensen
description: Kijk in de binnenkant naar 6 verschillende gebruiksgevallen voor hoe Mayo Clinic Workfront Fusion gebruikt om de manier waarop ze werken te transformeren.
...
# In Mayo Clinic: Hoe Workfront Fusion de mensen helpt

In samenwerking met Tia Calvert en Matt Lien van Mayo Clinic werd deze sessie gehouden en hierin werd een blik gelegd op zes verschillende gebruiksgevallen voor hoe Mayo Clinic Workfront Fusion gebruikt om de manier waarop ze werken te transformeren.
...
Fusie kost tijd en oefening, dus als je gewoon aan de slag bent, leer dan meer over de (gratis!) [&#x200B; de Opleiding van de Fusie op Experience League &#x200B;](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/fusion/welcome-to-workfront-fusion/workfront-fusion-overview) en aarzelt niet om hulp van andere klanten op de [&#x200B; Gemeenschap van de Fusie van Workfront te bereiken &#x200B;](https://experienceleaguecommunities.adobe.com/t5/workfront-fusion/ct-p/workfront-fusion-2?profile.language=nl).
