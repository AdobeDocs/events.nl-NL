    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Marketo & Mochas - Salesforce Sync">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="2025/salesforce-sync.md" target="_blank" rel="referrer" title="Marketo &amp; Mochas - Salesforce Sync"> Marketo &amp; Mochas - de Synchronisatie van Salesforce </a>
                    </p>
                    <p class="is-size-6">U kunt de synchronisatie tussen Marketo en Salesforce besturen met de hulp van experts op het gebied van machtigingen, zichtbaarheid in het veld, samenwerking met beheerders en aanbevolen procedures voor een vloeiende, geoptimaliseerde integratie.</p>
                </div>
