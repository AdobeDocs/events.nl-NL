...
Neem deel aan deze Experience League Live-sessie, waar productexperts van Adobe Campaign laten zien hoe u kanaalcampagnes kunt plannen, lanceren en meten in de nieuwe gebruikerservaring.
...
* De nieuwe Adobe-gebruikersinterface voor campagnes is gestart en is beschikbaar voor klanten die versie 8.6 van Adobe Campaign gebruiken.
* De webinterface biedt een uniforme en consistente gebruikerservaring voor alle Adobe Experience Cloud-producten.
* De homepage van Web UI staat snelle toegang tot alle toepassingen in Experience Cloud toe en verstrekt berichten en steunopties.
