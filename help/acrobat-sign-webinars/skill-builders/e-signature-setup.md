...
* **Naadloze integratie** aangezien vele documenten in Microsoft Word beginnen, staat het gebruiken van tekstmarkeringen u toe om met uw origineel document zonder de behoefte aan extra software of omzettingen te werken.U kunt het document in Word onderhouden en bewerken terwijl u nog steeds e-handtekeningen kunt verzamelen.

* **Volledige controle over vormgebieden** de markeringen van de Tekst geven u volledige controle over de plaatsing en de eigenschappen van vormgebieden.U kunt het veldtype opgeven (bijvoorbeeld handtekening, tekstinvoer, selectievakje), dit aan een specifieke deelnemer toewijzen, het naar wens of optioneel instellen en andere eigenschappen definiëren, zoals weergave, standaardwaarden en knopinfo.
...
* **de markeringen van de Tekst van de Flexibiliteit en van de aanpassing** staan u toe om diverse types van vormgebieden, met inbegrip van controledozen, radioknopen, dropdown lijsten, en meer te bepalen.Met deze flexibiliteit kunt u aangepaste formulieren maken die zijn afgestemd op uw specifieke behoeften en verschillende soorten informatie van deelnemers verzamelen.

* **Gemakkelijke verwijzing en begeleiding** Adobe verstrekt een gids van de tekstmarkering die de syntaxis en de structuur van tekstmarkeringen aantoont.Deze handleiding kan dienen als referentie bij het toepassen van tekstcodes op uw eigen documenten, zodat u deze op de juiste wijze opmaakt en alle beschikbare opties benut.
