...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">De Adobe Commerce Webinar-reeks is een maandelijks seminar voor klanten van Adobe Commerce dat een groot aantal onderwerpen bestrijkt, van best practices tot productroutekaart en trends in de branche.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="CX Analytics On-demand Webinars">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/docs/events/cx-analytics-ondemand-webinars/overview.html" title="CX Analytics-webinars op aanvraag" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-event-cx-analytics-on-demand-webinars.png" alt="CX Analytics-webinars op aanvraag"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/docs/events/cx-analytics-ondemand-webinars/overview.html" target="_blank" rel="referrer" title="CX Analytics-webinars op aanvraag"> CX Analytics Op bestelling Webinars </a>
                    </p>
                    <p class="is-size-6">Blader op aanvraag door CX Analytics-video's over productupdates, integratie, instapweigering en succesverhalen in de praktijk om up-to-date te blijven en expertise te ontwikkelen.</p>
                </div>
