...
description: De webinar van Adobe, onder leiding van senior veldingenieurs Jeff Homequest en Marco Lara, richtte zich op het migreren van serviceaccount JWT naar OAuth server-to-server referenties, waarbij de deadline van januari 2025 voor afgekeurde gegevens werd benadrukt, migratiestappen, voordelen van OAuth en speciale overwegingen voor AEM, met uitgebreide ondersteuning en documentatie voor het proces.
...
* **Inleiding van Sprekers** Jeff Homequest en Marco Lara, beide senior gebiedsingenieurs in Adobe, leidde webinar.
...
* **&#x200B; speciale overwegingen voor AEM** Het webinar behandelde hoe de migratie de wolk van AEM en klanten op prem, met inbegrip van specifieke toestemmingspatronen en configuraties beïnvloedt.
